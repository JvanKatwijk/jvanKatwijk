...
The third line shows a program for FM decoding and - under development - a first "module" for FT8 decoding, for use with the SDRconnect framework, an SDR program for the SDRplay devices.
